...
class Container extends Component {
  ...
  componentDidMount () {
    ...
    this.jumper.renderer.domElement.className = 'game'
    this.jumper.renderer.domElement.style = ''
    ...
    document.body.addEventListener('touchstart', this.jumper.handleDown)
    document.body.addEventListener('mouseup', this.jumper.handleUp)
    document.body.addEventListener('touchend', this.jumper.handleUp)
  }
  componentWillUnMount () {
    ...
    document.body.removeEventListener('touchstart', this.jumper.handleDown)
    document.body.removeEventListener('touchend', this.jumper.handleUp)
  }
  render () {
